...
const SingleProject = ({ id, name, desc, tags, code, demo, image, theme }) => {
  ...
  return (
    ...
    >
      <div class="absolute left-0 top-0 flex justify-center opacity-40">
      ...
      <p className='project--desc absolute w-[95%] min-h-[150px] translate-x-[-110%] translate-y-[50%] transition-transform duration-[0.9s] p-6 leading-[110%] rounded-[0_20px_20px_0] left-0 top-0 bg-[#0f0b24] text-[#EFF3F4]'>
        {desc}
      </p>
